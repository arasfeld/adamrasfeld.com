...
export function TrackRow({ track, rank }: TrackRowProps) {
  ...
  return (
    <div className="-mx-2 flex items-center gap-3.5 rounded-sm border-border border-b px-2 py-2.5 transition-colors hover:bg-surface-hover">
      {rank !== undefined && (
        <span className="w-5 flex-shrink-0 text-right font-mono text-[10px] text-muted-foreground tabular-nums">
